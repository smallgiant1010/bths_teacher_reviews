                            ...
                            .map(teacher => (
                                <div key={teacher._id} className="teacherProfile">
                                    ...
                                    <div className="rating">
                                        <input value="5" className={`rate-${teacher._id}`} id={`star5-${teacher._id}`} type="radio" />
                                        <label title="text" htmlFor={`star5-${teacher._id}`}></label>
                                        <input value="4" className={`rate-${teacher._id}`} id={`star4-${teacher._id}`} type="radio" />
                                        <label title="text" htmlFor={`star4-${teacher._id}`}></label>
                                        <input value="3" name={`rate-${teacher._id}`} id={`star3-${teacher._id}`} type="radio" defaultChecked />
                                        <label title="text" htmlFor={`star3-${teacher._id}`}></label>
                                        <input value="2" className={`rate-${teacher._id}`} id={`star2-${teacher._id}`} type="radio" />
                                        <label title="text" htmlFor={`star2-${teacher._id}`}></label>
                                        <input value="1" className={`rate-${teacher._id}`} id={`star1-${teacher._id}`} type="radio" />
                                        <label title="text" htmlFor={`star1-${teacher._id}`}></label>
                                    </div>
